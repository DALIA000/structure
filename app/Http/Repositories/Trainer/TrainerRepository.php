...
class TrainerRepository extends BaseRepository implements TrainerInterface
{
    ...
    public function __construct(Trainer $model, private StatusInterface $StatusI)
    {
        $this->model = $model;
    ...
    public function models($request)
    {
        $models = $this->model->where(function ($query) use ($request) {
            ...
            if ($request->exists('trainer_experience_level') && $request->trainer_experience_level !== null) {
                $query->where('trainer_experience_level_id', $request->trainer_experience_level);
            }
        });
