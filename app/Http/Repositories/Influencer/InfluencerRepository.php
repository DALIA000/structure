...
class InfluencerRepository extends BaseRepository implements InfluencerInterface
{
    public $loggedinUser;

    public function __construct(Influencer $model, private StatusInterface $StatusI)
    {
        $this->model = $model;
