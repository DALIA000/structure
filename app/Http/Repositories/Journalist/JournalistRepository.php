...
class JournalistRepository extends BaseRepository implements JournalistInterface
{
    public $loggedinUser;

    public function __construct(Journalist $model, private StatusInterface $StatusI)
    {
        $this->model = $model;
