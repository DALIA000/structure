...
class PlayerFootnessRepository extends BaseRepository implements PlayerFootnessInterface
{
    public function __construct(PlayerFootness $model)
    {
        $this->model = $model;
    }
